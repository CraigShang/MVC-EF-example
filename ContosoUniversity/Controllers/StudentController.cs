    ...
    public class StudentController : Controller
    {
        ...
        public ActionResult Index(string sortOrder,string currentFilter,string searchString,int? page)
        {
            ...
            switch (sortOrder) {
                ...
                case "FName":
                    students = students.OrderBy(s => s.FirstMidName);break;
                case "fname_desc":
                    students = students.OrderByDescending(s => s.FirstMidName);break;
                default:
        ...
        public ActionResult Create([Bind(Include = "LastName,FirstMidName,EnrollmentDate")] Student student)
        {
            try
            {
                ...
                ModelState.AddModelError("","Unable to save, please retry");
            }
            return View(student);
        }
        ...
        public ActionResult Delete(int? id,bool? saveChangesError = false)
        {
            ...
            if (saveChangesError.GetValueOrDefault()) {
                ViewBag.ErrorMessage = "Delete failed. Please retry.";
            }
            Student student = db.Students.Find(id);
            if (student == null)
            {
