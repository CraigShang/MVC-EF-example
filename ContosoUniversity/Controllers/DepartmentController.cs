...
namespace ContosoUniversity.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        // GET: Department
        //The method is marked with the async keyword, which tells the compiler 
        //to generate callbacks for parts of the method body and to automatically 
        //create the Task<ActionResult> object that is returned.
